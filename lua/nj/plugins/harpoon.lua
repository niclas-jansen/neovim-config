return {
  ...
  config = function()
    ...
    --
    vim.keymap.set("n", "<A-j>", function() harpoon:list():select(1) end, {desc = "Harpoon: Goto 1"})
    vim.keymap.set("n", "<A-k>", function() harpoon:list():select(2) end, {desc = "Harpoon: Goto 2"})
    vim.keymap.set("n", "<A-l>", function() harpoon:list():select(3) end, {desc = "Harpoon: Goto 3"})
    vim.keymap.set("n", "<A-;>", function() harpoon:list():select(4) end, {desc = "Harpoon: Goto 4"})
  end
}
